...
Exploring Insights/Inferences by performing EDA on the given data.<br>
Relevant graphs were plotted to get some insights on data using seaborn package.<br>
